...
namespace RazorClassLibrary
{
    public class Database
    {
        ...
        static readonly string ConnectionString = "Data Source=s-db2-smdrv\\SQLEXPRESS;TrustServerCertificate=True;Initial Catalog=ITProjectTrackerDB;User id=AppUser;Password=Password1*;";
